                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <i class="breadcrumb-item active" aria-current="page">Tüm Ürün Grupları</i>
                            </ol>
                        </nav>
                    </div>
                    @foreach ($productGroups as $data)
                        <div class="col-12 col-sm-12 col-md-6 col-lg-3 mb-5 h-100">
                            {{--<h4>@{{ data.model }}</h4>--}}
                            <div class="card shadow p-1" style="border:none">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>
                                        <a href="/products?productGroupId={{$data->id}}" class="btn btn-primary btn-block">
